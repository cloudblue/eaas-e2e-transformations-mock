...
You may modify at any time the credentials used to authenticate to connect modifying the file *.eaas_e2e_tfn_mock_dev.env*.
...
```sh
$ docker compose up eaas_e2e_tfn_mock_dev
```
...
```sh
$ docker compose up eaas_e2e_tfn_mock_bash
```
...
```sh
$ docker compose up eaas_e2e_tfn_mock_test
```
